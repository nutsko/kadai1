...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post names_url, params: { name: { first_name: @name.first_name, last_name: @name.last_name } }
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { first_name: @name.first_name, last_name: @name.last_name } }
